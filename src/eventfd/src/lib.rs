...
impl EventFD {
    ...
    pub fn read(&self) -> io::Result<u64> {
        ...
        let r = unsafe {
            ...
            libc::read(self.fd as c_int, ptr as *mut c_void, std::mem::size_of_val(&ret) as usize)
        };
    ...
    pub fn write(&self, val: u64) -> io::Result<()> {
        let r = unsafe {
            ...
            libc::write(self.fd as c_int, ptr as *const c_void, std::mem::size_of_val(&val) as usize)
        };
